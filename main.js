let APP_ID = "647234600c6f43628ce6d5b6655c6f04" //video app_id
...
} // to create meet for host or user 1 
...
let leaveChannel = async () => {
    await channel.leave()
    await client.logout()
} //to undisplay the content  when an user left the meeting
...
let toogleCamera = async () => {
    ...
    if (videoTrack.enabled) {
        ...
        document.getElementById('camera-btn').style.backgroundColor = 'rgba(216, 72, 15, 0.9)'
    }
    else {
        videoTrack.enabled = true
        document.getElementById('camera-btn').style.backgroundColor = 'rgb(219, 182, 182)'
    }
}
...
let toogleMic = async () => {
    ...
    if (audioTrack.enabled) {
        ...
        document.getElementById('mic-btn').style.backgroundColor = 'rgba(216, 72, 15, 0.9)'
    }
    else {
        audioTrack.enabled = true
        document.getElementById('mic-btn').style.backgroundColor = 'rgb(219, 182, 182)'
    }
}
